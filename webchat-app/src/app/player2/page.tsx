...
const GameMenu = () => {
  ...
  useEffect(() => {
    const storedInProgress =
      sessionStorage.getItem("actionInProgress_player2") === "true";
    const storedLockKey = sessionStorage.getItem("actionLockKey_player2");
    const storedLockTs = Number(
      sessionStorage.getItem("actionLockTs_player2") || "0"
    );
    ...
    if (storedInProgress && (!storedLockKey || isExpired)) {
      sessionStorage.removeItem("actionInProgress_player2");
      sessionStorage.removeItem("actionLockKey_player2");
      sessionStorage.removeItem("actionLockTs_player2");
  ...
  useEffect(() => {
    if (actionInProgress && actionLockKey) {
      sessionStorage.setItem("actionInProgress_player2", "true");
      sessionStorage.setItem("actionLockKey_player2", actionLockKey);
      if (!sessionStorage.getItem("actionLockTs_player2")) {
        sessionStorage.setItem(
          "actionLockTs_player2",
          Date.now().toString()
        );
      }
      return;
      ...
      ws.onmessage = (event) => {
        ...
        switch (data.action) {
          ...
          case "manual_make_default":
            // Check if this action affects player2
            if (data.player_id === "player2") {
  ...
  useEffect(() => {
    if (!gameState?.players?.player2?.hands?.[0]?.cards) return;

    const mainHandCards = gameState.players.player2.hands[0].cards;
  ...
  return (
    <div className="min-h-screen w-screen bg-[#450A03] overflow-hidden">
      {player2Active ? (
                              ...
                              <div className="flex items-center space-x-4">
                                <div>
                                  ...
                                  >
                                    ...
                                    {gameState.players.player2.even_money ===
                                      1 && (
                        ...
                        <div className="space-y-6">
                          ...
                          >
                            <div className="text-left mb-1">
                              <div
                                className={`text-lg font-medium ${isHandSelected(gameState, "player2", 0, 0)
                                  ? "text-gray-950"
                                  : "text-white"
                                  }`}
                              >
                            ...
                            {gameState.mode !== "manual" && (
                              <div className="absolute top-[90%] left-[43%] text-center">
                                <div className="inline-block bg-[#911606] px-3 py-1 rounded-full text-sm font-bold text-[#d4af37] border-2 border-[#d4af37]">
                                  Total:{" "}
                                  {gameState.players.player2.hands[0]?.total ??
                                    0}
                                </div>
                              </div>
                            )}
                            ...
                            {!(gameState?.mode === "live" && actionInProgress) && (
                              <div className="flex justify-center gap-8 flex-wrap mt-2 mb-4">
                                {gameState?.round_number !== 0 &&
                                  ...
                                  "playing" &&
                                  (gameState.players.player2.split1_status ===
                                    0 ||
                                    gameState.players.player2.split2_status ===
                                    0) && (
                                    <button
                                      onClick={() => {
                                        if (gameState?.mode === "live") {
                                          ...
                                          sessionStorage.setItem(
                                            "actionInProgress_player2",
                                            "true"
                                          );
                                          sessionStorage.setItem(
                                            "actionLockKey_player2",
                                            lockKey
                                          );
                                          sendWebSocketMessage({
                                            action: "set_live_function_hand",
                                ...
                                {gameState?.round_number !== 0 && (
                                  <>
                                    ...
                                    {gameState?.round_number !== 0 &&
                                      ...
                                      gameState?.dealer?.cards?.[0]?.[0] !==
                                      "A" &&
                                      gameState.players.player2.surrender ===
                                      0 && (
                                        <>
                                          <button
                                            onClick={() => {
        ...
        <div className='inline-block bg-[#911606] px-3 py-1 rounded-full text-sm font-bold text-[#d4af37] border-2 border-[#d4af37]'>
          Total:{' '}
          {gameState.players.player2.split1[0]?.total ??
            0}
        </div>
      </div> */}
            ...
            <>
              ...
              <button
                onClick={() => {
                  ...
                  clearInsuranceForHand('player2', 0, 1)
                }}
                              ...
                              <div className="mt-4">
                                ...
                                >
                                  ...
                                  {/* <div className='absolute top-[82%] left-[43%] text-center'>
                                    <div className='inline-block bg-[#911606] px-3 py-1 rounded-full text-sm font-bold text-[#d4af37] border-2 border-[#d4af37]'>
                                      Total:{' '}
                                      {gameState.players.player2.split2[0]?.total ??
                                        0}
                                    </div>
                                  </div> */}
                                        ...
                                        <>
                                          ...
                                          <button
                                            onClick={() => {
                                              ...
                                              clearInsuranceForHand('player2', 0, 2)
                                            }}
                                            className='px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors'
                                          >
                                            Hit
