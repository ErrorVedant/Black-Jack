                            ...
                            <div className='flex justify-center gap-2 flex-wrap mt-2 mb-4'>
                              {gameState?.round_number !== 0 &&
                                ...
                                gameState.players.player5.hands[0].status ===
                                  'playing' &&
                                (gameState.players.player5.split1_status === 0 || gameState.players.player5.split2_status === 0) && (
                                  <button
                                    onClick={() => {
                              ...
                              {gameState?.round_number !== 0 && (
                                  ...
                                  {gameState?.dealer?.cards?.[0]?.[0] === 'A' &&
                                    ...
                                    !gameState.players.player5.hands[0].insurence &&
                                    gameState.players.player5.split1_status === 0 &&
                                    gameState.players.player5.split2_status === 0 &&
                                    gameState.players.player5.hands[0]?.total !== 21 &&
                                    gameState.players.player5.hands[0]?.cards?.length === 2 &&
                                    gameState.players.player5.insurence === 0 && (
                                      <>
                                        <button
                                          onClick={() => {
                                            if (gameState?.mode === 'live') {
                                  ...
                                  {gameState?.round_number !== 0 &&
                                    ...
                                    gameState.players.player5.hands[0]?.cards?.length === 2 &&
                                    gameState.players.player5.hands[0]?.total === 21 &&
                                    gameState.players.player5.even_money === 0 && (
                                      <>
                                        <button
                                          onClick={() => {
                                            sendWebSocketMessage({
                                  ...
                                  {gameState?.round_number !== 0 &&
                                    gameState?.players?.player5?.hands[0]?.cards?.length === 2 &&
                                    gameState?.dealer?.cards?.[0]?.[0] !== 'A' &&
                                    gameState.players.player5.surrender === 0 && (
                                      <>
                                        <button
                                          onClick={() => {
                                            sendWebSocketMessage({
                                            ...
                                            clearInsuranceForHand('player5', 0, 0)
                                          }}
                                  ...
                                  {gameState.all_done === 1 && isHandSelected(gameState, 'player5', 0, 0) && gameState?.current_player === 'player5' && (
                                    <>
                                    <button
                                      onClick={() => {
                                        if (gameState?.mode === 'live') {
                                    ...
                                    {gameState?.round_number !== 0 &&
                                      ...
                                      gameState?.current_player ===
                                        ...
                                        <>
                                          ...
                                          {gameState?.players?.player5?.split1?.[0]?.cards?.length === 2 && (
                                            <button
                                              onClick={() => {
                                                if (gameState?.mode === 'live') {
                                                  sendWebSocketMessage({
                                    ...
                                    {gameState?.round_number !== 0 &&
                                      ...
                                      gameState?.current_player ===
                                        ...
                                        <>
                                          ...
                                          {gameState?.players?.player5?.split2?.[0]?.cards?.length === 2 && (
                                            <button
                                              onClick={() => {
                                                if (gameState?.mode === 'live') {
                                                  sendWebSocketMessage({
