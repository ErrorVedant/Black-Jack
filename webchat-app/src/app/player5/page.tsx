...
const GameMenu = () => {
  ...
  useEffect(() => {
    const storedInProgress =
      sessionStorage.getItem("actionInProgress_player5") === "true";
    const storedLockKey = sessionStorage.getItem("actionLockKey_player5");
    const storedLockTs = Number(
      sessionStorage.getItem("actionLockTs_player5") || "0"
    );
    ...
    if (storedInProgress && (!storedLockKey || isExpired)) {
      sessionStorage.removeItem("actionInProgress_player5");
      sessionStorage.removeItem("actionLockKey_player5");
      sessionStorage.removeItem("actionLockTs_player5");
  ...
  useEffect(() => {
    if (actionInProgress && actionLockKey) {
      sessionStorage.setItem("actionInProgress_player5", "true");
      sessionStorage.setItem("actionLockKey_player5", actionLockKey);
      if (!sessionStorage.getItem("actionLockTs_player5")) {
        sessionStorage.setItem(
          "actionLockTs_player5",
          Date.now().toString()
        );
      }
      return;
      ...
      ws.onmessage = (event) => {
        ...
        switch (data.action) {
          ...
          case "game_evaluated":
            ...
            setResultPopupDismissed(false);
            // Get player5's result
            const player5Data = data.game_state?.players?.player5;
            if (player5Data) {
              const mainHandResult = player5Data.hands?.[0]?.result;
              const split1Result = player5Data.split1?.[0]?.result;
              const split2Result = player5Data.split2?.[0]?.result;
            ...
            break;
          // Handle manual mode result actions for player5
          case "manual_make_win":
          case "manual_make_lose":
          case "manual_make_tie":
          case "manual_make_default":
            // Check if this action affects player5
            if (data.player_id === "player5") {
              setShowResultPopup(true);
  ...
  useEffect(() => {
    // Watch for manual mode result changes in game state for player5
    if (
  ...
  useEffect(() => {
    if (!gameState?.players?.player5?.hands?.[0]?.cards) return;

    const mainHandCards = gameState.players.player5.hands[0].cards;
  ...
  const player5Active = gameState?.players?.player5?.status === 1;
                ...
                {gameState?.players?.player5 && (
                  <div className="text-center">
                    <div
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        if (gameState.players.player5.status === 1) {
                          handlePlayerClick("player5");
                        }
                      }}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-4">
                          <div>
                            ...
                            >
                              Your Hand
                              {gameState.players.player5.insurence === 1 && (
                                <span className="ml-3 text-yellow-400 text-base font-semibold">
                                  Insured
                                </span>
                              )}
                              {gameState.players.player5.even_money === 1 && (
                        ...
                        <div className="space-y-6">
                          ...
                          >
                            ...
                            <div className="flex justify-center items-center gap-4 mb-4">
                              {gameState.players.player5.hands[0]?.cards?.map(
                                (card: string, index: number) => (
                                  <div
                                    key={index}
                            ...
                            {gameState.mode !== "manual" && (
                              <div className="absolute top-[90%] left-[43%] text-center">
                                <div className="inline-block bg-[#911606] px-3 py-1 rounded-full text-sm font-bold text-[#d4af37] border-2 border-[#d4af37]">
                                  Total:{" "}
                                  {gameState.players.player5.hands[0]?.total ??
                                    0}
                                </div>
                              </div>
                            )}
                                    ...
                                    <button
                                      onClick={() => {
                                        if (gameState?.mode === "live") {
                                          ...
                                          sessionStorage.setItem(
                                            "actionInProgress_player5",
                                            "true"
                                          );
                                          sessionStorage.setItem(
                                            "actionLockKey_player5",
                                            lockKey
                                          );
                                          sessionStorage.setItem(
                                            "actionLockTs_player5",
                                          ...
                                          {gameState.players.player5.hands[0]?.cards
                                            ?.length > 1 && (
                                              <button
                                                ...
                                                disabled={actionInProgress || gameState?.mode !== "live"}
                                                className={`px-4 py-2 bg-green-500 text-white rounded transition-colors ${actionInProgress || gameState?.mode !== "live"
                                          ...
                                          {gameState.players.player5.hands[0]
                                            ?.cards?.length === 2 && (
                                              <button
                                                ...
                                                disabled={actionInProgress || gameState?.mode !== "live"}
                                                className={`px-4 py-2 bg-orange-500 text-white rounded transition-colors ${actionInProgress || gameState?.mode !== "live"
                                                  ? "opacity-50 cursor-not-allowed"
                                                  : "hover:bg-orange-600"
                                                  }`}
                                              >
                                          ...
                                          {gameState.players.player5.hands[0]?.cards
                                            ?.length > 1 && (
                                              <button
                                                ...
                                                disabled={actionInProgress || gameState?.mode !== "live"}
                                                className={`px-4 py-2 bg-blue-500 text-white rounded transition-colors ${actionInProgress || gameState?.mode !== "live"
                                                  ? "opacity-50 cursor-not-allowed"
                                                  : "hover:bg-blue-600"
                                                  }`}
                                              >
                          ...
                          {gameState.mode === "manual" &&
                            gameState.players.player5.split1_status === 1 && (
                              <div className="mt-4">
                                <div
                                  className={`rounded-xl p-4 relative ${getHandBoxColor(
                                    isHandSelected(
                          ...
                          {gameState.mode === "manual" &&
                            gameState.players.player5.split2_status === 1 && (
                              <div className="mt-4">
                                <div
                                  className={`rounded-xl p-4 relative ${getHandBoxColor(
                                    isHandSelected(
                            ...
                            0 && (
                              <div className="mt-4">
                                ...
                                >
                                  ...
                                  <div className="flex justify-center items-center gap-4 mb-4">
                                    {gameState.players.player5.split1[0].cards.map(
                                      (card, index) => (
                                        <div
                                          key={index}
                                          className="relative w-36 h-52 transform hover:scale-110 transition-transform duration-200 group"
                                  ...
                                  {!(gameState?.mode === "live" && actionInProgress) && (
                                    <div className="flex justify-center gap-2 flex-wrap mt-2 mb-4">
                                      {gameState?.round_number !== 0 &&
                                        ...
                                        gameState?.current_player === "player5" &&
                                        gameState.players.player5.split1[0]?.cards
                                          ?.length === 2 &&
                                        canSplit(
                                          gameState.players.player5.split1[0]
                                            .cards
                            ...
                            0 && (
                              <div className="mt-4">
                                ...
                                >
                                  ...
                                  <div className="flex justify-center items-center gap-4 mb-4">
                                    {gameState.players.player5.split2[0].cards.map(
                                      (card, index) => (
                                        <div
                                          key={index}
                                          className="relative w-36 h-52 transform hover:scale-110 transition-transform duration-200 group"
                                  ...
                                  {!(gameState?.mode === "live" && actionInProgress) && (
                                    <div className="flex justify-center gap-2 flex-wrap mt-8">
                                      {gameState?.round_number !== 0 &&
                                        ...
                                        gameState?.current_player === "player5" &&
                                        gameState.players.player5.split2[0]?.cards
                                          ?.length === 2 &&
                                        canSplit(
                                          gameState.players.player5.split2[0]
                                            .cards
