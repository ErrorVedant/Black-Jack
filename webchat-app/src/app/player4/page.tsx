...
const GameMenu = () => {
  ...
  useEffect(() => {
    const storedInProgress =
      sessionStorage.getItem("actionInProgress_player4") === "true";
    const storedLockKey = sessionStorage.getItem("actionLockKey_player4");
    const storedLockTs = Number(
      sessionStorage.getItem("actionLockTs_player4") || "0"
    );
    ...
    if (storedInProgress && (!storedLockKey || isExpired)) {
      sessionStorage.removeItem("actionInProgress_player4");
      sessionStorage.removeItem("actionLockKey_player4");
      sessionStorage.removeItem("actionLockTs_player4");
  ...
  useEffect(() => {
    if (actionInProgress && actionLockKey) {
      sessionStorage.setItem("actionInProgress_player4", "true");
      sessionStorage.setItem("actionLockKey_player4", actionLockKey);
      if (!sessionStorage.getItem("actionLockTs_player4")) {
      ...
      ws.onmessage = (event) => {
        ...
        switch (data.action) {
          ...
          case "game_evaluated":
            ...
            // Get player4's result
            const player4Data = data.game_state?.players?.player4;
            if (player4Data) {
              const mainHandResult = player4Data.hands?.[0]?.result;
              const split1Result = player4Data.split1?.[0]?.result;
              const split2Result = player4Data.split2?.[0]?.result;
            ...
            break;
          // Handle manual mode result actions for player4
          case "manual_make_win":
          case "manual_make_lose":
          case "manual_make_tie":
          case "manual_make_default":
            // Check if this action affects player4
            if (data.player_id === "player4") {
              setShowResultPopup(true);
  ...
  useEffect(() => {
    // Watch for manual mode result changes in game state for player4
    if (
      ...
      const player4Data = gameState.players.player4;
      const mainHandResult = player4Data.hands?.[0]?.result;
      const split1Result = player4Data.split1?.[0]?.result;
      const split2Result = player4Data.split2?.[0]?.result;
    ...
    gameState?.players?.player4?.hands?.[0]?.result,
    gameState?.players?.player4?.split1?.[0]?.result,
    gameState?.players?.player4?.split2?.[0]?.result,
    gameState?.mode,
    showResultPopup,
  ...
  const player4Active = gameState?.players?.player4?.status === 1;
                  ...
                  {/* <div className='flex justify-center'>
                    <div className='inline-block px-4 sm:px-6 py-1.5 sm:py-2 bg-[#7a1105] text-white font-semibold rounded shadow-md'>
                      ...
                      <span className='text-yellow-300'>
                        {gameState?.players?.player4?.status === 1
                          ? 'Active'
                          : 'Inactive'}
                      </span>
                      {gameState?.game_phase && (
                ...
                {gameState?.players?.player4 && (
                  <div className="text-center">
                    <div
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        if (gameState.players.player4.status === 1) {
                          handlePlayerClick("player4");
                        }
                      }}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-4">
                          <div>
                            ...
                            >
                              Your Hand
                              {gameState.players.player4.insurence === 1 && (
                                <span className="ml-3 text-yellow-400 text-base font-semibold">
                                  Insured
                                </span>
                              )}
                              {gameState.players.player4.even_money === 1 && (
                        ...
                        <div className="space-y-6">
                          ...
                          <div
                            className={`rounded-xl p-4 relative ${getHandBoxColor(
                              isHandSelected(gameState, "player4", 0, 0) &&
                          ...
                          >
                            <div className="text-left mb-1">
                              <div
                                className={`text-lg font-medium ${isHandSelected(gameState, "player4", 0, 0)
                                    ? "text-gray-950"
                                    : "text-white"
                                  }`}
                              >
                            ...
                            <div className="flex justify-center items-center gap-4 mb-4">
                              {gameState.players.player4.hands[0]?.cards?.map(
                                (card: string, index: number) => (
                                  <div
                                    key={index}
                            ...
                            {gameState.mode !== "manual" && (
                              <div className="absolute top-[90%] left-[43%] text-center">
                                <div className="inline-block bg-[#911606] px-3 py-1 rounded-full text-sm font-bold text-[#d4af37] border-2 border-[#d4af37]">
                                  Total:{" "}
                                  {gameState.players.player4.hands[0]?.total ??
                                    0}
                                </div>
                              </div>
                            )}
                            ...
                            {!(gameState?.mode === "live" && actionInProgress) && (
                              <div className="flex justify-center gap-2 flex-wrap mt-2 mb-4">
                                {gameState?.round_number !== 0 &&
                                  ...
                                  gameState.players.player4.hands[0].status ===
                                  "playing" &&
                                  (gameState.players.player4.split1_status ===
                                    0 ||
                                    gameState.players.player4.split2_status ===
                                    0) && (
                                    <button
                                      onClick={() => {
                                ...
                                {/* Main Hand Action Buttons for Player 4 */}
                                {gameState?.round_number !== 0 && (
                                  <>
                                    {gameState?.dealer?.cards?.[0]?.[0] === "A" &&
                                      !insuranceState[`player4_0_0`] &&
                                      !gameState.players.player4.hands[0]
                                        .insurence &&
                                      gameState.players.player4.split1_status ===
                                      0 &&
                                      ...
                                      gameState.players.player4.hands[0]?.cards
                                        ?.length === 2 &&
                                      gameState.players.player4.insurence ===
                                      0 && (
                                        <>
                                          <button
                                            onClick={() => {
                                    ...
                                    {gameState?.round_number !== 0 &&
                                      ...
                                      gameState.players.player4.hands[0]
                                        ?.total === 21 &&
                                      gameState.players.player4.even_money ===
                                      0 && (
                                        <>
                                          <button
                                            onClick={() => {
                                    ...
                                    {gameState?.round_number !== 0 &&
                                      ...
                                      gameState?.dealer?.cards?.[0]?.[0] !==
                                      "A" &&
                                      gameState.players.player4.surrender ===
                                      0 && (
                                        <>
                                          <button
                                            onClick={() => {
                          ...
                          {gameState.mode === "manual" &&
                            gameState.players.player4.split1_status === 1 && (
                              <div className="mt-4">
                                <div
                                  className={`rounded-xl p-4 relative ${getHandBoxColor(
                                    isHandSelected(
                          ...
                          {gameState.mode === "manual" &&
                            gameState.players.player4.split2_status === 1 && (
                              <div className="mt-4">
                                <div
                                  className={`rounded-xl p-4 relative ${getHandBoxColor(
                                    isHandSelected(
                          ...
                          {gameState.mode !== "manual" &&
                            gameState.players.player4.split1[0]?.cards?.length >
                            0 && (
                              <div className="mt-4">
                                <div
                                  className={`rounded-xl p-4 relative ${getHandBoxColor(
                                ...
                                >
                                  ...
                                  <div className="flex justify-center items-center gap-4 mb-4">
                                    {gameState.players.player4.split1[0].cards.map(
                                      (card, index) => (
                                        <div
                                          key={index}
                                          className="relative w-36 h-52 transform hover:scale-110 transition-transform duration-200 group"
                                  ...
                                  {/* Split1 Hand Action Buttons for Player 4 */}
                                  {!(gameState?.mode === "live" && actionInProgress) && (
                                    <div className="flex justify-center gap-2 flex-wrap mt-2 mb-4">
                                      {gameState?.round_number !== 0 &&
                                        isHandSelected(
                          ...
                          {gameState.mode !== "manual" &&
                            gameState.players.player4.split2[0]?.cards?.length >
                            0 && (
                              <div className="mt-4">
                                <div
                                  className={`rounded-xl p-4 relative ${getHandBoxColor(
                                ...
                                >
                                  ...
                                  <div className="flex justify-center items-center gap-4 mb-4">
                                    {gameState.players.player4.split2[0].cards.map(
                                      (card, index) => (
                                        <div
                                          key={index}
                                          className="relative w-36 h-52 transform hover:scale-110 transition-transform duration-200 group"
                                  ...
                                  {/* Split2 Hand Action Buttons for Player 4 */}
                                  {!(gameState?.mode === "live" && actionInProgress) && (
              ...
              <div className="bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 border-4 border-yellow-400 text-white p-8 rounded-3xl shadow-2xl max-w-lg w-full mx-4 relative overflow-hidden">
                ...
                <div className="text-center relative z-10">
                  ...
                  <div className="mb-6 space-y-3">
                    {(() => {
                      const player4Data = gameState?.players?.player4;
                      if (!player4Data) return null;
                      const handResults = [
                        {
                          label: "Main Hand",
                          result: player4Data.hands?.[0]?.result,
                          icon: "🎰",
                        },
                        {
                          label: "Split 1",
                          result: player4Data.split1?.[0]?.result,
                          icon: "🃏",
                        },
                        {
                          label: "Split 2",
                          result: player4Data.split2?.[0]?.result,
                          icon: "🎯",
                        },
                      ];

                      if (player4Data.insurence === 1) {
                        handResults.push({
                          label: "Insurance",
                          result:
